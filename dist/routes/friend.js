...
router.post('/', auth_1.default.checkToken, [
    ...
    (0, express_validator_1.check)("name", "Please enter a name with 5 or less characters").isLength({ max: 5 }),
...
//친구 메모 수정 
router.put('/memo/:friendId', auth_1.default.checkToken, (0, express_validator_1.check)("memo", "Memo is required").not().isEmpty(), controllers_1.friendController.editFriendMemo);
//친구 이름 수정 
router.put('/:friendId', auth_1.default.checkToken, (0, express_validator_1.check)("name", "Name is required").not().isEmpty(), controllers_1.friendController.editFriendName);
//친구 삭제 
