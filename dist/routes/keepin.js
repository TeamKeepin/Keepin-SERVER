...
//키핀하기 생성
router.post('/all', auth_1.default.checkToken, multer_1.default.array('photo', 3), controllers_1.keepinController.createKeepin);
//키핀하기 생성 1
router.post('/', auth_1.default.checkToken, controllers_1.keepinController.createKeepinText);
//키핀하기 이미지생성 2
router.post('/photo/:keepinIdx', auth_1.default.checkToken, multer_1.default.array('photo', 3), controllers_1.keepinController.createKeepinPhoto);
// 모아보기 받은/준 필터링
...
// 키핀 수정
router.put('/modify/:keepinIdx', auth_1.default.checkToken, multer_1.default.array('photo', 3), controllers_1.keepinController.modifyKeepin);
// router.put('/:keepinIdx', auth.checkToken, keepinController.modifyKeepin);
// 키핀 삭제
router.post('/delete', auth_1.default.checkToken, controllers_1.keepinController.deleteKeepin);
