...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (fcm !== user.phoneToken) {
            ...
            yield services_1.userService.editPhoneToken({ userIdx: user._id, phoneToken: fcm });
            // 2. user._id로 지나지 않은 리마인더 조회헤서 그 라미인더에 있는 fcm을 req body 받은 fcm으로 변경
            yield services_1.reminderService.findSpecificIsPassedReminder({ userIdx: user._id, phoneToken: fcm });
        }
        // Return jsonwebtoken
        const payload = {
            id: user._id,
        ...
        const result = {
            accessToken: jsonwebtoken_1.default.sign(payload, config_1.default.jwtSecret, { expiresIn: '5d' }),
            refreshToken: jsonwebtoken_1.default.sign(payload, config_1.default.jwtSecret, { expiresIn: '10d' }),
        };
        // refreshToken을 DB에 저장
        const userInfo = yield services_1.userService.saveRefreshToken({ id: payload.id, refreshToken: result.refreshToken });
        res.json({
            status: returnCode_1.default.OK,
            message: '로그인 성공',
            data: {
 ...
 * }
 */
const emailCheck = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
        res.status(400).json({
            status: returnCode_1.default.BAD_REQUEST,
...
const editProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield services_1.userService.editUser({ userIdx, name });
        return res.status(returnCode_1.default.OK).json({
            status: returnCode_1.default.OK,
            message: '프로필 수정 성공',
        });
...
const editPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield services_1.userService.editPassword({ userIdx, password: hashPwd });
        return res.status(returnCode_1.default.OK).json({
            status: returnCode_1.default.OK,
            message: '비밀번호 수정 성공',
        });
 ...
 * }
 */
const findEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const user = yield services_1.userService.findUserEmail({ name, birth, phone });
        if (!user) {
            return res.status(returnCode_1.default.BAD_REQUEST).json({
                status: returnCode_1.default.BAD_REQUEST,
                message: '일치하는 이메일이 없습니다',
 ...
 * }
 */
const findPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const tempPassword = crypto_1.default.randomBytes(3).toString('hex');
        const transporter = nodemailer_1.default.createTransport({
            ...
            auth: {
                ...
                pass: config_1.default.keepinPassword,
            },
        });
        const emailOptions = {
            ...
            html: '<h1 >Keepin에서 임시 비밀번호를 알려드립니다.</h1> <h2> password : ' +
                tempPassword +
                '</h2>' +
        ...
        transporter.sendMail(emailOptions, (error, info) => {
            if (error) {
                console.log(error);
                return res.status(returnCode_1.default.INTERNAL_SERVER_ERROR).json({
                    status: returnCode_1.default.INTERNAL_SERVER_ERROR,
        ...
        const salt = yield bcryptjs_1.default.genSalt(10);
        const hashPwd = yield bcryptjs_1.default.hash(tempPassword, salt);
 ...
 * }
 */
const editPhone = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userIdx = req._id;
    ...
    try {
        ...
        yield services_1.userService.editPhone({ userIdx, phone });
        return res.status(returnCode_1.default.OK).json({
            status: returnCode_1.default.OK,
            message: '전화번호 수정 성공',
        });
